                ...
                <Box 
                    ...
                    <Box display={"flex"} justifyContent={"center"} gap={"100px"} >
                            ...
                            <Box width={"50%"} margin={"auto"}>
                                <Typography padding={"30px 0px"} position={"relative"} width={"70%"} fontWeight={"900"}  fontSize={"40px"} fontFamily={"unigeo3"} color={"var(--second)"}>La Solution numérique de vote : <span style={{color: "var(--thirst)"}}>VOTEO</span></Typography>
                                ...
                                <Box display={"flex"} justifyContent={"space-between"} paddingBottom={"100px"}>
                                    ...
                                    <Box color={"var(--second)"} marginRight={"100px"}>
                    ...
                    <Box display={"flex"} justifyContent={"center"} gap={"100px"} marginTop={"50px"}>
